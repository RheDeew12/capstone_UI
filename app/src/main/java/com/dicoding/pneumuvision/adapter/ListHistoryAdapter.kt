package com.dicoding.pneumuvision.adapter
...
class ListHistoryAdapter(private val listAnimal: ArrayList<Lungs>) : RecyclerView.Adapter<ListHistoryAdapter.ListViewHolder>(){
